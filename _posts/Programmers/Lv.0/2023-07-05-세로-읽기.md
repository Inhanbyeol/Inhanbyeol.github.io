...
> 문제를 직접 풀어보실 경우 [**여기**](https://school.programmers.co.kr/learn/courses/30/lessons/181904){:target="_blank"}를 클릭해 주세요.
{: .prompt-tip }
...
function solution(my_string, m, c) {
    return Array(Math.ceil(my_string.length/m)).fill().map((_,i) => [...my_string.substr(i*m,m)][c-1]).join('')
}

//[...my_string.substr(i*m,m)][c-1]
