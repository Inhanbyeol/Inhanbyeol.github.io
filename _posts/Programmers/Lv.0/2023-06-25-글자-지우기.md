...
> 문제를 직접 풀어보실 경우 [**여기**](https://school.programmers.co.kr/learn/courses/30/lessons/181900){:target="_blank"}를 클릭해 주세요.
{: .prompt-tip }
...
function solution(my_string, indices) {
    return [...my_string].filter((x,i,a) => indices.indexOf(i) == -1).join('');
}
