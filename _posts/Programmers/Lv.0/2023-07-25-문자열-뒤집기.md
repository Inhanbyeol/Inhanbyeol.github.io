...
> 문제를 직접 풀어보실 경우 [**여기**](https://school.programmers.co.kr/learn/courses/30/lessons/181905){:target="_blank"}를 클릭해 주세요.
{: .prompt-tip }
...
function solution(my_string, s, e) {
    return my_string.replace(my_string.substring(s,e+1),[...my_string.substring(s,e+1)].reverse().join(''))
}
